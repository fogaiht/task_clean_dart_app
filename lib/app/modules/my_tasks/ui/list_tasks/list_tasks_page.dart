...
import '../update_task/update_task_page.dart';
...
class _ListTasksPageState extends ModularState<ListTasksPage, ListTasksController> {
  @override
                  ...
                  child: ListTile(
                    ...
                    trailing: IconButton(
                        ...
                        onPressed: () async {
                          ...
                          Scaffold.of(context).showSnackBar(SnackBar(content: Text("${task.description} dismissed")));
                        }),
                  ),
                );
              });
