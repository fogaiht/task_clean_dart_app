...
class UpdateTaskController = _UpdateTaskControllerBase with _$UpdateTaskController;
...
abstract class _UpdateTaskControllerBase with Store {
  ...
  @action
  setDescription(String description) => task = task.copyWith(description: description);
