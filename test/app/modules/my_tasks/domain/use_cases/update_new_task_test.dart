...
import 'package:task_clean_dart_app/app/modules/my_tasks/domain/use_cases/update_task.dart';
...
void main() {
  ...
  group('UpdateTask Test happy path', () {
    test("Update a Task Right Way", () async {
      when(repository.updateTask(any)).thenAnswer((_) async => right(completeTask));
