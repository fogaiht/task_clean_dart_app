...
import 'package:task_clean_dart_app/app/modules/my_tasks/domain/use_cases/retrieve_all_task.dart';
...
void main() {
  ...
  group('Retrieve all tasks Test happy path', () {
    test("Retrieve all tasks Right Way", () async {
      when(repository.retrieveAllTask()).thenAnswer((_) async => right(<Task>[]));
